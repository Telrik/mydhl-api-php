...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-mock.dhl.com/mydhlapi';
    ...
    {
        $report  = 'PHP SDK (MyDHL\Client) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                ...
                "description" => "Mock Server (simulate API responses with fixed test data)",
            ],
            [
