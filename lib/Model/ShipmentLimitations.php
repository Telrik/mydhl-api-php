 ...
 */
class ShipmentLimitations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'max_number_of_pieces' => '\MyDHL\Client\Model\ValueUnit',
        'max_shipment_weight' => '\MyDHL\Client\Model\ValueUnit',
        'html' => 'string'
    ];
    ...
    protected static array $openAPINullables = [
        'max_number_of_pieces' => false,
        'max_shipment_weight' => false,
        'html' => false
    ];
    ...
    {
        $this->setIfExists('max_number_of_pieces', $data ?? [], null);
        $this->setIfExists('max_shipment_weight', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \MyDHL\Client\Model\ValueUnit|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\ValueUnit|null $max_number_of_pieces max_number_of_pieces
     *
     * @return self
     */
    public function setMaxNumberOfPieces($max_number_of_pieces)
    {
        if (is_null($max_number_of_pieces)) {
            throw new \InvalidArgumentException('non-nullable max_number_of_pieces cannot be null');
        }
     ...
     *
     * @param \MyDHL\Client\Model\ValueUnit|null $max_shipment_weight max_shipment_weight
     *
     * @return self
     */
    public function setMaxShipmentWeight($max_shipment_weight)
    {
        if (is_null($max_shipment_weight)) {
            throw new \InvalidArgumentException('non-nullable max_shipment_weight cannot be null');
        }
