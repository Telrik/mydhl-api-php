...
/**
 * SupermodelIoLogisticsExpressPickupRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressPickupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressPickupRequest';
    ...
    protected static $openAPITypes = [
        ...
        'special_instructions' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressPickupRequestSpecialInstructionsInner[]',
        'remark' => 'string',
        'customer_details' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressPickupRequestCustomerDetails',
        'shipment_details' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner[]'
    ];
    ...
    */
    ...
    public function setPlannedPickupDateAndTime($planned_pickup_date_and_time)
    {
        ...
        if ((mb_strlen($planned_pickup_date_and_time) > 29)) {
            throw new \InvalidArgumentException('invalid length for $planned_pickup_date_and_time when calling SupermodelIoLogisticsExpressPickupRequest., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($planned_pickup_date_and_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $planned_pickup_date_and_time when calling SupermodelIoLogisticsExpressPickupRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCloseTime($close_time)
    {
        ...
        if ((mb_strlen($close_time) > 5)) {
            throw new \InvalidArgumentException('invalid length for $close_time when calling SupermodelIoLogisticsExpressPickupRequest., must be smaller than or equal to 5.');
        }
        if ((!preg_match("/([0-1][0-9]|2[0-3]):([0-5][0-9])/", ObjectSerializer::toString($close_time)))) {
            throw new \InvalidArgumentException("invalid value for \$close_time when calling SupermodelIoLogisticsExpressPickupRequest., must conform to the pattern /([0-1][0-9]|2[0-3]):([0-5][0-9])/.");
        }
    ...
    public function setLocation($location)
    {
        ...
        if ((mb_strlen($location) > 80)) {
            throw new \InvalidArgumentException('invalid length for $location when calling SupermodelIoLogisticsExpressPickupRequest., must be smaller than or equal to 80.');
        }
     ...
     * Sets accounts
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressAccount[] $accounts accounts
     *
     * @return self
     */
    public function setAccounts($accounts)
    {
        ...
        if ((count($accounts) > 5)) {
            throw new \InvalidArgumentException('invalid value for $accounts when calling SupermodelIoLogisticsExpressPickupRequest., number of items must be less than or equal to 5.');
        }
        if ((count($accounts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $accounts when calling SupermodelIoLogisticsExpressPickupRequest., number of items must be greater than or equal to 1.');
        }
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressPickupRequestSpecialInstructionsInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressPickupRequestSpecialInstructionsInner[]|null $special_instructions Details special pickup instructions you may wish to send to the DHL Courier.
     *
     * @return self
     */
    public function setSpecialInstructions($special_instructions)
    {
        ...
        if ((count($special_instructions) > 4)) {
            throw new \InvalidArgumentException('invalid value for $special_instructions when calling SupermodelIoLogisticsExpressPickupRequest., number of items must be less than or equal to 4.');
        }
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressPickupRequestCustomerDetails
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressPickupRequestCustomerDetails $customer_details customer_details
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner[]
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner[] $shipment_details Please provide details related to shipment you want to do the pickup for
     *
     * @return self
     */
    public function setShipmentDetails($shipment_details)
    {
        ...
        if ((count($shipment_details) > 999)) {
            throw new \InvalidArgumentException('invalid value for $shipment_details when calling SupermodelIoLogisticsExpressPickupRequest., number of items must be less than or equal to 999.');
        }
        if ((count($shipment_details) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipment_details when calling SupermodelIoLogisticsExpressPickupRequest., number of items must be greater than or equal to 1.');
        }
