...
class Holidays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'open' => '\MyDHL\Client\Model\OpenDatesTime[]',
        'closed' => '\MyDHL\Client\Model\ClosedDates[]'
    ];
    ...
    */
     ...
     * Gets open
     *
     * @return \MyDHL\Client\Model\OpenDatesTime[]|null
     */
     ...
     * Sets open
     *
     * @param \MyDHL\Client\Model\OpenDatesTime[]|null $open Array of objects: {date, from, to}, where date is date and from and to is time
     *
     * @return self
     */
     ...
     * Gets closed
     *
     * @return \MyDHL\Client\Model\ClosedDates[]|null
     */
     ...
     * Sets closed
     *
     * @param \MyDHL\Client\Model\ClosedDates[]|null $closed Array of dates:{from, to} when is closed.
     *
     * @return self
     */
