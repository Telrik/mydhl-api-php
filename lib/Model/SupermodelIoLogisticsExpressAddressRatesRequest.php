...
/**
 * SupermodelIoLogisticsExpressAddressRatesRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressAddressRatesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressAddressRatesRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['address_line1']) && (mb_strlen($this->container['address_line1']) > 45)) {
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 12)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($postal_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCityName($city_name)
    {
        ...
        if ((mb_strlen($city_name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $city_name when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($city_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city_name when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setProvinceCode($province_code)
    {
        ...
        if ((mb_strlen($province_code) > 35)) {
            throw new \InvalidArgumentException('invalid length for $province_code when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($province_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $province_code when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be bigger than or equal to 2.');
        }
     ...
     * Sets address_line1
     *
     * @param string|null $address_line1 Please enter address line 1
     *
     * @return self
     */
    public function setAddressLine1($address_line1)
    {
        ...
        if ((mb_strlen($address_line1) > 45)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($address_line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets address_line2
     *
     * @param string|null $address_line2 Please enter address line 3
     *
     * @return self
     */
    public function setAddressLine2($address_line2)
    {
        ...
        if ((mb_strlen($address_line2) > 45)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($address_line2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine3($address_line3)
    {
        ...
        if ((mb_strlen($address_line3) > 45)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($address_line3) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCountyName($county_name)
    {
        ...
        if ((mb_strlen($county_name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $county_name when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($county_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $county_name when calling SupermodelIoLogisticsExpressAddressRatesRequest., must be bigger than or equal to 1.');
        }
