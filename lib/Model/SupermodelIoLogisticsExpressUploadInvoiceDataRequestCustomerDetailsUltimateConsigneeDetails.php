...
/**
 * SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsUltimateConsigneeDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsUltimateConsigneeDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails_ultimateConsigneeDetails';
    ...
    protected static $openAPITypes = [
        'postal_address' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressAddress',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['registration_numbers']) && (count($this->container['registration_numbers']) > 10)) {
            $invalidProperties[] = "invalid value for 'registration_numbers', number of items must be less than or equal to 10.";
        }
     ...
     * Gets postal_address
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressAddress
     */
     ...
     * Sets postal_address
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressAddress $postal_address postal_address
     *
     * @return self
     */
     ...
     * Sets type_code
     *
     * @param string|null $type_code Please enter the business party type of the ultimate consignee
     *
     * @return self
     */
    ...
    public function setRegistrationNumbers($registration_numbers)
    {
        ...
        if ((count($registration_numbers) > 10)) {
            throw new \InvalidArgumentException('invalid value for $registration_numbers when calling SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsUltimateConsigneeDetails., number of items must be less than or equal to 10.');
        }
