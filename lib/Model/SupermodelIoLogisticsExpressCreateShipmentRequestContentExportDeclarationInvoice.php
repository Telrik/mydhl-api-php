...
class SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'customer_references' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoiceCustomerReferencesInner[]',
        'terms_of_payment' => 'string',
        'indicative_customs_values' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoiceIndicativeCustomsValues',
        'pre_calculated_total_values' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoicePreCalculatedTotalValues'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'pre_calculated_total_values' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'pre_calculated_total_values' => false
    ];
    ...
    protected static $setters = [
        ...
        'pre_calculated_total_values' => 'setPreCalculatedTotalValues'
    ];
    ...
    protected static $getters = [
        ...
        'pre_calculated_total_values' => 'getPreCalculatedTotalValues'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pre_calculated_total_values', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoiceCustomerReferencesInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoiceCustomerReferencesInner[]|null $customer_references Please provide the customer references at invoice level. It is recommended to provide less than 20 customer references of 'MRN' type code.
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoiceIndicativeCustomsValues|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoiceIndicativeCustomsValues|null $indicative_customs_values indicative_customs_values
     *
     * @return self
     */
    ...
    /**
     * Gets pre_calculated_total_values
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoicePreCalculatedTotalValues|null
     */
    public function getPreCalculatedTotalValues()
    {
        return $this->container['pre_calculated_total_values'];
    }

    /**
     * Sets pre_calculated_total_values
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationInvoicePreCalculatedTotalValues|null $pre_calculated_total_values pre_calculated_total_values
     *
     * @return self
     */
    public function setPreCalculatedTotalValues($pre_calculated_total_values)
    {
        if (is_null($pre_calculated_total_values)) {
            throw new \InvalidArgumentException('non-nullable pre_calculated_total_values cannot be null');
        }
        $this->container['pre_calculated_total_values'] = $pre_calculated_total_values;
