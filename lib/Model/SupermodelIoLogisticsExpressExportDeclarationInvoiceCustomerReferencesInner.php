...
/**
 * SupermodelIoLogisticsExpressExportDeclarationInvoiceCustomerReferencesInner Class Doc Comment
 *
 * @category Class
 * @package  MyDHL\Client
 * @author   OpenAPI Generator team
 ...
 */
class SupermodelIoLogisticsExpressExportDeclarationInvoiceCustomerReferencesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressExportDeclaration_invoice_customerReferences_inner';
    ...
    */
    ...
    public function setTypeCode($type_code)
    {
        ...
        if ((mb_strlen($type_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $type_code when calling SupermodelIoLogisticsExpressExportDeclarationInvoiceCustomerReferencesInner., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($type_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $type_code when calling SupermodelIoLogisticsExpressExportDeclarationInvoiceCustomerReferencesInner., must be bigger than or equal to 2.');
        }
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 35)) {
            throw new \InvalidArgumentException('invalid length for $value when calling SupermodelIoLogisticsExpressExportDeclarationInvoiceCustomerReferencesInner., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling SupermodelIoLogisticsExpressExportDeclarationInvoiceCustomerReferencesInner., must be bigger than or equal to 1.');
        }
