...
class SupermodelIoLogisticsExpressImageUploadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setOriginalPlannedShippingDate($original_planned_shipping_date)
    {
        ...
        if ((!preg_match("/^\\d{4}\\-(0[1-9]|1[012])\\-(0[1-9]|[12][0-9]|3[01])$/", ObjectSerializer::toString($original_planned_shipping_date)))) {
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressDocumentImagesInner[]
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressDocumentImagesInner[] $document_images This section is to support multiple base64 encoded string with the image of export documentation for Paperless Trade images. When an invalid base64 encoded string is provided, an error message will be returned
     *
     * @return self
     */
