...
/**
 * SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsBrokerDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsBrokerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails_brokerDetails';
    ...
    */
     ...
     * Sets type_code
     *
     * @param string|null $type_code Please enter the business party type of the broker
     *
     * @return self
     */
    ...
    public function setRegistrationNumbers($registration_numbers)
    {
        ...
        if ((count($registration_numbers) > 10)) {
            throw new \InvalidArgumentException('invalid value for $registration_numbers when calling SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsBrokerDetails., number of items must be less than or equal to 10.');
        }
