...
/**
 * SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsBuyerDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsBuyerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressCreateShipmentRequest_customerDetails_buyerDetails';
    ...
    protected static $openAPITypes = [
        ...
        'contact_information' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressContactBuyer',
    ...
    */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressContactBuyer
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressContactBuyer $contact_information contact_information
     *
     * @return self
     */
    ...
    public function setRegistrationNumbers($registration_numbers)
    {
        ...
        if ((count($registration_numbers) > 50)) {
            throw new \InvalidArgumentException('invalid value for $registration_numbers when calling SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsBuyerDetails., number of items must be less than or equal to 50.');
        }
    ...
    public function setBankDetails($bank_details)
    {
        ...
        if ((count($bank_details) > 1)) {
            throw new \InvalidArgumentException('invalid value for $bank_details when calling SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsBuyerDetails., number of items must be less than or equal to 1.');
        }
     ...
     * Sets type_code
     *
     * @param string|null $type_code Please enter the business party type of the buyer
     *
     * @return self
     */
