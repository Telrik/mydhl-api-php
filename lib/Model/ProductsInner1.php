...
class ProductsInner1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'weight' => '\MyDHL\Client\Model\Weight1',
        'total_price' => '\MyDHL\Client\Model\ProductsInner1TotalPriceInner[]',
        'total_price_breakdown' => '\MyDHL\Client\Model\ProductsInner1TotalPriceBreakdownInner[]',
        'detailed_price_breakdown' => '\MyDHL\Client\Model\ProductsInner1DetailedPriceBreakdownInner[]',
        'service_code_mutually_exclusive_groups' => '\MyDHL\Client\Model\ProductsInnerServiceCodeMutuallyExclusiveGroupsInner[]',
        'service_code_dependency_rule_groups' => '\MyDHL\Client\Model\ProductsInnerServiceCodeDependencyRuleGroupsInner[]',
        'pickup_capabilities' => '\MyDHL\Client\Model\ProductsInner1PickupCapabilities',
        'delivery_capabilities' => '\MyDHL\Client\Model\ProductsInner1DeliveryCapabilities',
        'items' => 'object[]',
        'pricing_date' => 'string'
    ];
    ...
    */
     ...
     * Gets weight
     *
     * @return \MyDHL\Client\Model\Weight1
     */
     ...
     * Sets weight
     *
     * @param \MyDHL\Client\Model\Weight1 $weight weight
     *
     * @return self
     */
     ...
     * Gets total_price
     *
     * @return \MyDHL\Client\Model\ProductsInner1TotalPriceInner[]
     */
     ...
     * Sets total_price
     *
     * @param \MyDHL\Client\Model\ProductsInner1TotalPriceInner[] $total_price total_price
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\ProductsInner1TotalPriceBreakdownInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\ProductsInner1TotalPriceBreakdownInner[]|null $total_price_breakdown total_price_breakdown
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\ProductsInner1DetailedPriceBreakdownInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\ProductsInner1DetailedPriceBreakdownInner[]|null $detailed_price_breakdown detailed_price_breakdown
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\ProductsInnerServiceCodeMutuallyExclusiveGroupsInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\ProductsInnerServiceCodeMutuallyExclusiveGroupsInner[]|null $service_code_mutually_exclusive_groups Group of serviceCodes that are mutually exclusive.  Only one serviceCode among the list must be applied for a shipment
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\ProductsInnerServiceCodeDependencyRuleGroupsInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\ProductsInnerServiceCodeDependencyRuleGroupsInner[]|null $service_code_dependency_rule_groups Dependency rule groups for a particular serviceCode.
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\ProductsInner1PickupCapabilities|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\ProductsInner1PickupCapabilities|null $pickup_capabilities pickup_capabilities
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\ProductsInner1DeliveryCapabilities|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\ProductsInner1DeliveryCapabilities|null $delivery_capabilities delivery_capabilities
     *
     * @return self
     */
