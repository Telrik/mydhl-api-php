...
class SupermodelIoLogisticsExpressCreateShipmentRequestOutputImagePropertiesImageOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shipment_receipt_customer_data_text' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'shipment_receipt_customer_data_text' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'shipment_receipt_customer_data_text' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'shipment_receipt_customer_data_text' => 'shipmentReceiptCustomerDataText'
    ];
    ...
    protected static $setters = [
        ...
        'shipment_receipt_customer_data_text' => 'setShipmentReceiptCustomerDataText'
    ];
    ...
    protected static $getters = [
        ...
        'shipment_receipt_customer_data_text' => 'getShipmentReceiptCustomerDataText'
    ];
    ...
    public const TYPE_CODE_SHIPMENT_RECEIPT = 'shipmentReceipt';
    ...
    public function getTypeCodeAllowableValues()
    {
        return [
            ...
            self::TYPE_CODE_SHIPMENT_RECEIPT,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('shipment_receipt_customer_data_text', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['language_script_code']) && (mb_strlen($this->container['language_script_code']) > 4)) {
            $invalidProperties[] = "invalid value for 'language_script_code', the character length must be smaller than or equal to 4.";
        }

        if (!is_null($this->container['language_script_code']) && (mb_strlen($this->container['language_script_code']) < 4)) {
            $invalidProperties[] = "invalid value for 'language_script_code', the character length must be bigger than or equal to 4.";
        }
        ...
        if (!is_null($this->container['shipment_receipt_customer_data_text']) && (mb_strlen($this->container['shipment_receipt_customer_data_text']) > 700)) {
            $invalidProperties[] = "invalid value for 'shipment_receipt_customer_data_text', the character length must be smaller than or equal to 700.";
        }

        if (!is_null($this->container['shipment_receipt_customer_data_text']) && (mb_strlen($this->container['shipment_receipt_customer_data_text']) < 1)) {
            $invalidProperties[] = "invalid value for 'shipment_receipt_customer_data_text', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets is_requested
     *
     * @param bool|null $is_requested To be used for waybillDoc, invoice, shipment receipt and QRcode. If set to true then the document is provided otherwise not
     *
     * @return self
     */
     ...
     * Sets language_code
     *
     * @param string|null $language_code Please enter ISO 3 letters language code for invoice or shipment receipt
     *
     * @return self
     */
     ...
     *
     * @param string|null $language_country_code Please enter ISO 2 letters language country code for invoice or shipment receipt
     *
     * @return self
     */
     ...
     *
     * @param string|null $language_script_code Please enter ISO 4 letters language script code for shipment receipt
     *
     * @return self
     */
    public function setLanguageScriptCode($language_script_code)
    {
        ...
        if ((mb_strlen($language_script_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $language_script_code when calling SupermodelIoLogisticsExpressCreateShipmentRequestOutputImagePropertiesImageOptionsInner., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($language_script_code) < 4)) {
            throw new \InvalidArgumentException('invalid length for $language_script_code when calling SupermodelIoLogisticsExpressCreateShipmentRequestOutputImagePropertiesImageOptionsInner., must be bigger than or equal to 4.');
        }
    ...
    /**
     * Gets shipment_receipt_customer_data_text
     *
     * @return string|null
     */
    public function getShipmentReceiptCustomerDataText()
    {
        return $this->container['shipment_receipt_customer_data_text'];
    }

    /**
     * Sets shipment_receipt_customer_data_text
     *
     * @param string|null $shipment_receipt_customer_data_text Declaration text that can be printed in certain shipment receipt template
     *
     * @return self
     */
    public function setShipmentReceiptCustomerDataText($shipment_receipt_customer_data_text)
    {
        if (is_null($shipment_receipt_customer_data_text)) {
            throw new \InvalidArgumentException('non-nullable shipment_receipt_customer_data_text cannot be null');
        }
        if ((mb_strlen($shipment_receipt_customer_data_text) > 700)) {
            throw new \InvalidArgumentException('invalid length for $shipment_receipt_customer_data_text when calling SupermodelIoLogisticsExpressCreateShipmentRequestOutputImagePropertiesImageOptionsInner., must be smaller than or equal to 700.');
        }
        if ((mb_strlen($shipment_receipt_customer_data_text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipment_receipt_customer_data_text when calling SupermodelIoLogisticsExpressCreateShipmentRequestOutputImagePropertiesImageOptionsInner., must be bigger than or equal to 1.');
        }

        $this->container['shipment_receipt_customer_data_text'] = $shipment_receipt_customer_data_text;
