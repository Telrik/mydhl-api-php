...
/**
 * SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressCreateShipmentRequest_customerDetails_shipperDetails';
    ...
    */
    ...
    public function setRegistrationNumbers($registration_numbers)
    {
        ...
        if ((count($registration_numbers) > 50)) {
            throw new \InvalidArgumentException('invalid value for $registration_numbers when calling SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails., number of items must be less than or equal to 50.');
        }
    ...
    public function setBankDetails($bank_details)
    {
        ...
        if ((count($bank_details) > 1)) {
            throw new \InvalidArgumentException('invalid value for $bank_details when calling SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails., number of items must be less than or equal to 1.');
        }
     ...
     * Sets type_code
     *
     * @param string|null $type_code Please enter the business party role type of the shipper
     *
     * @return self
     */
