...
class SupermodelIoLogisticsExpressPackage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type_code' => 'string',
        'weight' => 'float',
        'dimensions' => '\MyDHL\Client\Model\Dimensions',
        'customer_references' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageReference[]',
        'identifiers' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifier[]',
        'description' => 'string',
        'label_barcodes' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageLabelBarcodesInner[]',
        'label_text' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageLabelTextInner[]',
    ...
    */
     ...
     * Gets dimensions
     *
     * @return \MyDHL\Client\Model\Dimensions
     */
     ...
     * Sets dimensions
     *
     * @param \MyDHL\Client\Model\Dimensions $dimensions dimensions
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageReference[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageReference[]|null $customer_references Here you can declare your customer references for each package
     *
     * @return self
     */
     ...
     * Sets identifiers
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifier[]|null $identifiers Identifiers section is on the package level where you can optionaly provide a DHL Express waybill number. This has to be enabled by your DHL Express IT contact.
     *
     * @return self
     */
     ...
     * Gets label_barcodes
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageLabelBarcodesInner[]|null
     */
     ...
     * Sets label_barcodes
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageLabelBarcodesInner[]|null $label_barcodes This allows you to define up to two bespoke barcodes on the DHL Express Tranport label. To use this feature please set outputImageProperties/imageOptions/templateName as ECOM26_84CI_003 for typeCode=label
     *
     * @return self
     */
     ...
     * Gets label_text
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageLabelTextInner[]|null
     */
     ...
     * Sets label_text
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageLabelTextInner[]|null $label_text This allows you to enter up to two bespoke texts on the DHL Express Tranport label. To use this feature please set outputImageProperties/imageOptions/templateName as ECOM26_84CI_003 for typeCode=label
     *
     * @return self
     */
     ...
     *
     * @param float|null $reference_number Please enter package reference number. If package reference number is provided for at least one package, then package reference number must be provided for all packages.
     *
     * @return self
     */
    public function setReferenceNumber($reference_number)
    {
        ...
        if (($reference_number > 999)) {
            throw new \InvalidArgumentException('invalid value for $reference_number when calling SupermodelIoLogisticsExpressPackage., must be smaller than or equal to 999.');
        }
        if (($reference_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $reference_number when calling SupermodelIoLogisticsExpressPackage., must be bigger than or equal to 1.');
        }
