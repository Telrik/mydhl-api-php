...
/**
 * SupermodelIoLogisticsExpressUploadInvoiceDataRequestOutputImagePropertiesImageOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  MyDHL\Client
 * @author   OpenAPI Generator team
 ...
 */
class SupermodelIoLogisticsExpressUploadInvoiceDataRequestOutputImagePropertiesImageOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressUploadInvoiceDataRequest_outputImageProperties_imageOptions_inner';
    ...
    */
     ...
     * Sets template_name
     *
     * @param string|null $template_name Please enter DHL Express document template name.
     *
     * @return self
     */
    public function setTemplateName($template_name)
    {
        ...
        if ((mb_strlen($template_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $template_name when calling SupermodelIoLogisticsExpressUploadInvoiceDataRequestOutputImagePropertiesImageOptionsInner., must be smaller than or equal to 25.');
        }
     ...
     * Sets is_requested
     *
     * @param bool|null $is_requested If set to true then the document is rendered otherwise not
     *
     * @return self
     */
