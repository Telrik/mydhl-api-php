 ...
 */
class OpeningTime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const DAY_OF_WEEK_HOLIDAY = 'HOLIDAY';
    ...
    */
     ...
     * Sets day_of_week
     *
     * @param string|null $day_of_week Weekday for which this opening hours entity is valid. Possible values are: MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY, HOLIDAY
     *
     * @return self
     */
     ...
     * Sets opening_time
     *
     * @param string|null $opening_time The opening time of this entity
     *
     * @return self
     */
     ...
     * Sets closing_time
     *
     * @param string|null $closing_time The closing time of this entity
     *
     * @return self
     */
