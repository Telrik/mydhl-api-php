...
/**
 * SupermodelIoLogisticsExpressCreateShipmentRequestGetAdditionalInformationInner Class Doc Comment
 *
 * @category Class
 * @package  MyDHL\Client
 * @author   OpenAPI Generator team
 ...
 */
class SupermodelIoLogisticsExpressCreateShipmentRequestGetAdditionalInformationInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressCreateShipmentRequest_getAdditionalInformation_inner';
    ...
    public const TYPE_CODE_PICKUP_DETAILS = 'pickupDetails';
    public const TYPE_CODE_OPTIONAL_SHIPMENT_DATA = 'optionalShipmentData';
    public const TYPE_CODE_BARCODE_INFORMATION = 'barcodeInformation';
    public const TYPE_CODE_LINK_LABELS_BY_PIECES = 'linkLabelsByPieces';
    ...
    {
        return [
            self::TYPE_CODE_PICKUP_DETAILS,
            self::TYPE_CODE_OPTIONAL_SHIPMENT_DATA,
            self::TYPE_CODE_BARCODE_INFORMATION,
            self::TYPE_CODE_LINK_LABELS_BY_PIECES,
        ];
    }
    ...
    */
     ...
     * Sets type_code
     *
     * @param string|null $type_code Provide type code of data that can be returned in response.  Values can be pickupDetails, optionalShipmentData, transliterateResponse and linkLabelsByPieces (link label image generated for each package level)
     *
     * @return self
     */
     ...
     * Sets is_requested
     *
     * @param bool $is_requested is_requested
     *
     * @return self
     */
