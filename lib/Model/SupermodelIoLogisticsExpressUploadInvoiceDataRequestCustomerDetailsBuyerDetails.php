...
/**
 * SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsBuyerDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsBuyerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails_buyerDetails';
    ...
    */
    ...
    public function setRegistrationNumbers($registration_numbers)
    {
        ...
        if ((count($registration_numbers) > 10)) {
            throw new \InvalidArgumentException('invalid value for $registration_numbers when calling SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsBuyerDetails., number of items must be less than or equal to 10.');
        }
