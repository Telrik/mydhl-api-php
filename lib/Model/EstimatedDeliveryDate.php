 ...
 */
class EstimatedDeliveryDate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'estimated_delivery_date';
    ...
    */
    ...
    public function setTypeCode($type_code)
    {
        ...
        if ((mb_strlen($type_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $type_code when calling EstimatedDeliveryDate., must be smaller than or equal to 4.');
        }
