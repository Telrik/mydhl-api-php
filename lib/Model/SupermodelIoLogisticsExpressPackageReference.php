...
/**
 * SupermodelIoLogisticsExpressPackageReference Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressPackageReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressPackageReference';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 35)) {
            throw new \InvalidArgumentException('invalid length for $value when calling SupermodelIoLogisticsExpressPackageReference., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling SupermodelIoLogisticsExpressPackageReference., must be bigger than or equal to 1.');
        }
    ...
    public function setTypeCode($type_code)
    {
        ...
        if ((mb_strlen($type_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $type_code when calling SupermodelIoLogisticsExpressPackageReference., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($type_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $type_code when calling SupermodelIoLogisticsExpressPackageReference., must be bigger than or equal to 2.');
        }
