...
/**
 * SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner Class Doc Comment
 *
 * @category Class
 * @package  MyDHL\Client
 * @author   OpenAPI Generator team
 ...
 */
class SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressPickupRequest_shipmentDetails_inner';
    ...
    protected static $openAPITypes = [
        ...
        'value_added_services' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressValueAddedServicesRates[]',
        'is_customs_declarable' => 'bool',
        'declared_value' => 'float',
        'declared_value_currency' => 'string',
        'unit_of_measurement' => 'string',
        'shipment_tracking_number' => 'string',
        'packages' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageRR[]'
    ];
    ...
    */
    ...
    public function setProductCode($product_code)
    {
        ...
        if ((mb_strlen($product_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $product_code when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($product_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $product_code when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setLocalProductCode($local_product_code)
    {
        ...
        if ((mb_strlen($local_product_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $local_product_code when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($local_product_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $local_product_code when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., must be bigger than or equal to 1.');
        }
     ...
     * Sets accounts
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressAccount[]|null $accounts Please enter all the DHL Express accounts related to this shipment
     *
     * @return self
     */
    public function setAccounts($accounts)
    {
        ...
        if ((count($accounts) > 5)) {
            throw new \InvalidArgumentException('invalid value for $accounts when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., number of items must be less than or equal to 5.');
        }
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressValueAddedServicesRates[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressValueAddedServicesRates[]|null $value_added_services This section communicates additional shipping services, such as Insurance (or Shipment Value Protection).
     *
     * @return self
     */
    public function setValueAddedServices($value_added_services)
    {
        ...
        if ((count($value_added_services) > 99)) {
            throw new \InvalidArgumentException('invalid value for $value_added_services when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., number of items must be less than or equal to 99.');
        }
    ...
    public function setDeclaredValue($declared_value)
    {
        ...
        if (($declared_value > 999999999999999)) {
            throw new \InvalidArgumentException('invalid value for $declared_value when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., must be smaller than or equal to 999999999999999.');
        }
        if (($declared_value < 0)) {
            throw new \InvalidArgumentException('invalid value for $declared_value when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setDeclaredValueCurrency($declared_value_currency)
    {
        ...
        if ((mb_strlen($declared_value_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $declared_value_currency when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($declared_value_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $declared_value_currency when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., must be bigger than or equal to 3.');
        }
     ...
     * Gets packages
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageRR[]
     */
     ...
     * Sets packages
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressPackageRR[] $packages Here you can define properties per package
     *
     * @return self
     */
    public function setPackages($packages)
    {
        ...
        if ((count($packages) > 999)) {
            throw new \InvalidArgumentException('invalid value for $packages when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., number of items must be less than or equal to 999.');
        }
        if ((count($packages) < 1)) {
            throw new \InvalidArgumentException('invalid length for $packages when calling SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner., number of items must be greater than or equal to 1.');
        }
