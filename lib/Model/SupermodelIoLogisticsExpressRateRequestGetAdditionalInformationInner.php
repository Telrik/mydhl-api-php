<?php
/**
 * SupermodelIoLogisticsExpressRateRequestGetAdditionalInformationInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SupermodelIoLogisticsExpressRateRequestGetAdditionalInformationInner Class Doc Comment
 *
 * @category Class
 * @package  MyDHL\Client
 * @author   OpenAPI Generator team
 ...
 */
class SupermodelIoLogisticsExpressRateRequestGetAdditionalInformationInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressRateRequest_getAdditionalInformation_inner';
    ...
    public const TYPE_CODE_ALL_VALUE_ADDED_SERVICES = 'allValueAddedServices';
    public const TYPE_CODE_ALL_VALUE_ADDED_SERVICES_AND_RULE_GROUPS = 'allValueAddedServicesAndRuleGroups';
    ...
    {
        return [
            self::TYPE_CODE_ALL_VALUE_ADDED_SERVICES,
            self::TYPE_CODE_ALL_VALUE_ADDED_SERVICES_AND_RULE_GROUPS,
        ];
    }
    ...
    */
     ...
     * Sets type_code
     *
     * @param string|null $type_code Provide type code of data that can be returned in response.  Values can be allValueAddedServices, allValueAddedServicesAndRuleGroups
     *
     * @return self
     */
