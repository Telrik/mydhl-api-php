...
class SupermodelIoLogisticsExpressCreateShipmentRequestOnDemandDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $special_instructions Please enter additional information that might be useful for the DHL Express courier. This field is conditionally mandatory if selected location is 'Other'.
     *
     * @return self
     */
