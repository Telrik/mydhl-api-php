...
/**
 * SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsUltimateConsigneeDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsUltimateConsigneeDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressCreateShipmentRequest_customerDetails_ultimateConsigneeDetails';
    ...
    protected static $openAPITypes = [
        ...
        'bank_details' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressRegistrationNumbers',
        'type_code' => 'string'
    ];
    ...
    */
    ...
    public function setRegistrationNumbers($registration_numbers)
    {
        ...
        if ((count($registration_numbers) > 50)) {
            throw new \InvalidArgumentException('invalid value for $registration_numbers when calling SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsUltimateConsigneeDetails., number of items must be less than or equal to 50.');
        }
     ...
     * Sets bank_details
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressRegistrationNumbers|null $bank_details bank_details
     *
     * @return self
     */
     ...
     * Sets type_code
     *
     * @param string|null $type_code Please enter the business party role type of the ultimate consignee
     *
     * @return self
     */
