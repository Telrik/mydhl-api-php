<?php
/**
 * SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerQuantity
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerQuantity Class Doc Comment
 *
 * @category Class
 ...
 */
class SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerQuantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'supermodelIoLogisticsExpressCreateShipmentRequest_content_exportDeclaration_lineItems_inner_quantity';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['unit_of_measurement']) > 8)) {
            $invalidProperties[] = "invalid value for 'unit_of_measurement', the character length must be smaller than or equal to 8.";
        }
    ...
    public function setValue($value)
    {
        ...
        if (($value > 1000000000)) {
            throw new \InvalidArgumentException('invalid value for $value when calling SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerQuantity., must be smaller than or equal to 1000000000.');
        }
        if (($value < 1)) {
            throw new \InvalidArgumentException('invalid value for $value when calling SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerQuantity., must be bigger than or equal to 1.');
        }
    ...
    public function setUnitOfMeasurement($unit_of_measurement)
    {
        ...
        if ((mb_strlen($unit_of_measurement) > 8)) {
            throw new \InvalidArgumentException('invalid length for $unit_of_measurement when calling SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerQuantity., must be smaller than or equal to 8.');
        }
