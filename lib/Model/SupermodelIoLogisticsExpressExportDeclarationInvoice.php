...
class SupermodelIoLogisticsExpressExportDeclarationInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'date' => 'string',
        'function' => 'string',
        'customer_references' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationInvoiceCustomerReferencesInner[]',
        'indicative_customs_values' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationInvoiceIndicativeCustomsValues',
        'pre_calculated_total_values' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationInvoicePreCalculatedTotalValues'
    ];
    ...
    */
    ...
    public function setDate($date)
    {
        ...
        if ((!preg_match("/^\\d{4}\\-(0[1-9]|1[012])\\-(0[1-9]|[12][0-9]|3[01])$/", ObjectSerializer::toString($date)))) {
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationInvoiceCustomerReferencesInner[]|null
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationInvoiceIndicativeCustomsValues|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationInvoiceIndicativeCustomsValues|null $indicative_customs_values indicative_customs_values
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationInvoicePreCalculatedTotalValues|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationInvoicePreCalculatedTotalValues|null $pre_calculated_total_values pre_calculated_total_values
     *
     * @return self
     */
