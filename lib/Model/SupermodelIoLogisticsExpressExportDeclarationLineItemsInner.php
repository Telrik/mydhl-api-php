...
class SupermodelIoLogisticsExpressExportDeclarationLineItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'price' => 'float',
        'quantity' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerQuantity',
        ...
        'weight' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerWeight',
        'is_taxes_paid' => 'bool',
        'customer_references' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerCustomerReferencesInner[]',
        'customs_documents' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerCustomsDocumentsInner[]',
    ...
    */
     ...
     * Gets quantity
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerQuantity
     */
     ...
     * Sets quantity
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerQuantity $quantity quantity
     *
     * @return self
     */
     ...
     * Gets weight
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerWeight
     */
     ...
     * Sets weight
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerWeight $weight weight
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerCustomerReferencesInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerCustomerReferencesInner[]|null $customer_references Please provide the Customer References for the line item
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerCustomsDocumentsInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressExportDeclarationLineItemsInnerCustomsDocumentsInner[]|null $customs_documents Please provide the customs documents details
     *
     * @return self
     */
    ...
    public function setPreCalculatedLineItemTotalValue($pre_calculated_line_item_total_value)
    {
        ...
        if (($pre_calculated_line_item_total_value > 999999999999999)) {
            throw new \InvalidArgumentException('invalid value for $pre_calculated_line_item_total_value when calling SupermodelIoLogisticsExpressExportDeclarationLineItemsInner., must be smaller than or equal to 999999999999999.');
        }
        if (($pre_calculated_line_item_total_value < 0)) {
            throw new \InvalidArgumentException('invalid value for $pre_calculated_line_item_total_value when calling SupermodelIoLogisticsExpressExportDeclarationLineItemsInner., must be bigger than or equal to 0.');
        }
