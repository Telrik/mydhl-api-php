...
/**
 * EstimatedDeliveryDate1 Class Doc Comment
 *
 * @category Class
 ...
 */
class EstimatedDeliveryDate1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'estimated_delivery_date_1';
    ...
    public const TYPE_CODE_QDDC = 'QDDC';
    public const TYPE_CODE_QDDF = 'QDDF';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('type_code', $data ?? [], 'QDDF');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['type_code']) && (mb_strlen($this->container['type_code']) > 4)) {
            $invalidProperties[] = "invalid value for 'type_code', the character length must be smaller than or equal to 4.";
        }
     ...
     * Sets type_code
     *
     * @param string|null $type_code Please indicate the EDD type being requested
     *
     * @return self
     */
    public function setTypeCode($type_code)
    {
        ...
        if ((mb_strlen($type_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $type_code when calling EstimatedDeliveryDate1., must be smaller than or equal to 4.');
        }
