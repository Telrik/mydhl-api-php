...
class SupermodelIoLogisticsExpressCreateShipmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'pickup' => '\MyDHL\Client\Model\Pickup',
        'product_code' => 'string',
        'local_product_code' => 'string',
        'get_rate_estimates' => 'bool',
        'accounts' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressAccount[]',
        'value_added_services' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressValueAddedServices[]',
        'output_image_properties' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOutputImageProperties',
        'customer_references' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressReference[]',
        'identifiers' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifier[]',
        'customer_details' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetails',
        'content' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContent',
        'document_images' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressDocumentImagesInner[]',
        'on_demand_delivery' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOnDemandDelivery',
        'request_ondemand_delivery_url' => 'bool',
        'shipment_notification' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestShipmentNotificationInner[]',
        'prepaid_charges' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestPrepaidChargesInner[]',
        'get_transliterated_response' => 'bool',
        'estimated_delivery_date' => '\MyDHL\Client\Model\EstimatedDeliveryDate',
        'get_additional_information' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestGetAdditionalInformationInner[]',
        'parent_shipment' => '\MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestParentShipment'
    ];
    ...
    */
     ...
     * Gets pickup
     *
     * @return \MyDHL\Client\Model\Pickup
     */
     ...
     * Sets pickup
     *
     * @param \MyDHL\Client\Model\Pickup $pickup pickup
     *
     * @return self
     */
     ...
     * Gets accounts
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressAccount[]
     */
     ...
     * Sets accounts
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressAccount[] $accounts Please enter all the DHL Express accounts and types to be used for this shipment
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressValueAddedServices[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressValueAddedServices[]|null $value_added_services This section communicates additional shipping services, such as Insurance (or Shipment Value Protection).
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOutputImageProperties|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOutputImageProperties|null $output_image_properties output_image_properties
     *
     * @return self
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressReference[]|null $customer_references Here you can declare your customer references
     *
     * @return self
     */
     ...
     * Gets identifiers
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifier[]|null
     */
     ...
     * Sets identifiers
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifier[]|null $identifiers Identifiers section is on the shipment level where you can optionaly provide a DHL Express waybill number. This has to be enabled by your DHL Express IT contact.
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetails
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetails $customer_details customer_details
     *
     * @return self
     */
     ...
     * Gets content
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContent
     */
     ...
     * Sets content
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestContent $content content
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressDocumentImagesInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressDocumentImagesInner[]|null $document_images This section is to support multiple base64 encoded string with the image of export documentation for Paperless Trade images. When an invalid base64 encoded string is provided, an error message will be returned
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOnDemandDelivery|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestOnDemandDelivery|null $on_demand_delivery on_demand_delivery
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestShipmentNotificationInner[]|null
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestPrepaidChargesInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestPrepaidChargesInner[]|null $prepaid_charges Please provide any charges you have already paid for this shipment, like freight paid upfront. To allow using this section please contact your DHL Express representative
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\EstimatedDeliveryDate|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\EstimatedDeliveryDate|null $estimated_delivery_date estimated_delivery_date
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestGetAdditionalInformationInner[]|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestGetAdditionalInformationInner[]|null $get_additional_information Provides additional information in the response like service area details, routing code and pickup-related information
     *
     * @return self
     */
     ...
     *
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestParentShipment|null
     */
     ...
     *
     * @param \MyDHL\Client\Model\SupermodelIoLogisticsExpressCreateShipmentRequestParentShipment|null $parent_shipment parent_shipment
     *
     * @return self
     */
