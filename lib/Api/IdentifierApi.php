...
class IdentifierApi
{
     ...
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifierResponse|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse
     */
     ...
     * @throws \MyDHL\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifierResponse|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function expApiIdentifiersWithHttpInfo($account_number, $type, $size, $message_reference = null, $message_reference_date = null, $plugin_name = null, $plugin_version = null, $shipping_system_platform_name = null, $shipping_system_platform_version = null, $webstore_platform_name = null, $webstore_platform_version = null, string $contentType = self::contentTypes['expApiIdentifiers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifierResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifierResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifierResponse', []),
            ...
            $returnType = '\MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifierResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyDHL\Client\Model\SupermodelIoLogisticsExpressIdentifierResponse',
