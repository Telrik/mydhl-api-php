...
class RatingApi
{
     ...
     * Landed Cost
     *
     * @param  \MyDHL\Client\Model\SupermodelIoLogisticsExpressLandedCostRequest $supermodel_io_logistics_express_landed_cost_request Details about the requested shipment (required)
     ...
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressRates|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse
     */
     ...
     * @throws \MyDHL\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MyDHL\Client\Model\SupermodelIoLogisticsExpressRates|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function expApiLandedCostWithHttpInfo($supermodel_io_logistics_express_landed_cost_request, $message_reference = null, $message_reference_date = null, $plugin_name = null, $plugin_version = null, $shipping_system_platform_name = null, $shipping_system_platform_version = null, $webstore_platform_name = null, $webstore_platform_version = null, string $contentType = self::contentTypes['expApiLandedCost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDHL\Client\Model\SupermodelIoLogisticsExpressRates' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyDHL\Client\Model\SupermodelIoLogisticsExpressRates' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyDHL\Client\Model\SupermodelIoLogisticsExpressRates', []),
            ...
            $returnType = '\MyDHL\Client\Model\SupermodelIoLogisticsExpressRates';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyDHL\Client\Model\SupermodelIoLogisticsExpressRates',
     ...
     *
     * @param  \MyDHL\Client\Model\SupermodelIoLogisticsExpressRateRequest $supermodel_io_logistics_express_rate_request Details about the requested shipment (required)
     * @param  string $message_reference Please provide message reference (optional)
     * @param  string $message_reference_date Optional reference date in the  HTTP-date format https://tools.ietf.org/html/rfc7231#section-7.1.1.2 (optional)
     * @param  string $plugin_name Please provide name of the plugin (applicable to 3PV only) (optional)
     * @param  string $plugin_version Please provide version of the plugin (applicable to 3PV only) (optional)
