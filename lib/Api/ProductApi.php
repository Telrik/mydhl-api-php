...
class ProductApi
{
     ...
     * @param  string $estimated_delivery_date_type Estimated Delivery Date Type. QDDF: is the fastest transit time as quoted to the customer at booking or shipment creation. When clearance or any other non-transport operational component is expected to impact transit time, QDDF does not constitute DHL&#39;s service commitment. QDDC: cconstitutes DHL&#39;s service commitment as quoted at booking or shipment creation. QDDC builds in clearance time, and potentially other special operational non-transport component(s), when relevant. (optional, default to 'QDDF')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['expApiProducts'] to see the possible values for this operation
     *
     * @throws \MyDHL\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \MyDHL\Client\Model\SupermodelIoLogisticsExpressProducts|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse
     */
    public function expApiProducts($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code = null, $destination_postal_code = null, $next_business_day = null, $message_reference = null, $message_reference_date = null, $plugin_name = null, $plugin_version = null, $shipping_system_platform_name = null, $shipping_system_platform_version = null, $webstore_platform_name = null, $webstore_platform_version = null, $strict_validation = false, $get_all_value_added_services = false, $request_estimated_delivery_date = true, $estimated_delivery_date_type = 'QDDF', string $contentType = self::contentTypes['expApiProducts'][0])
    {
        list($response) = $this->expApiProductsWithHttpInfo($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code, $destination_postal_code, $next_business_day, $message_reference, $message_reference_date, $plugin_name, $plugin_version, $shipping_system_platform_name, $shipping_system_platform_version, $webstore_platform_name, $webstore_platform_version, $strict_validation, $get_all_value_added_services, $request_estimated_delivery_date, $estimated_delivery_date_type, $contentType);
        return $response;
    }

    /**
     * Operation expApiProductsWithHttpInfo
     *
     * Retrieve available DHL Express products for a one piece Shipment
     *
     * @param  string $account_number DHL Express customer account number (required)
     ...
     * @throws \MyDHL\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \MyDHL\Client\Model\SupermodelIoLogisticsExpressProducts|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse|\MyDHL\Client\Model\SupermodelIoLogisticsExpressErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function expApiProductsWithHttpInfo($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code = null, $destination_postal_code = null, $next_business_day = null, $message_reference = null, $message_reference_date = null, $plugin_name = null, $plugin_version = null, $shipping_system_platform_name = null, $shipping_system_platform_version = null, $webstore_platform_name = null, $webstore_platform_version = null, $strict_validation = false, $get_all_value_added_services = false, $request_estimated_delivery_date = true, $estimated_delivery_date_type = 'QDDF', string $contentType = self::contentTypes['expApiProducts'][0])
    {
        $request = $this->expApiProductsRequest($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code, $destination_postal_code, $next_business_day, $message_reference, $message_reference_date, $plugin_name, $plugin_version, $shipping_system_platform_name, $shipping_system_platform_version, $webstore_platform_name, $webstore_platform_version, $strict_validation, $get_all_value_added_services, $request_estimated_delivery_date, $estimated_delivery_date_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDHL\Client\Model\SupermodelIoLogisticsExpressProducts' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyDHL\Client\Model\SupermodelIoLogisticsExpressProducts' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MyDHL\Client\Model\SupermodelIoLogisticsExpressProducts', []),
            ...
            $returnType = '\MyDHL\Client\Model\SupermodelIoLogisticsExpressProducts';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyDHL\Client\Model\SupermodelIoLogisticsExpressProducts',
     ...
     */
    public function expApiProductsAsync($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code = null, $destination_postal_code = null, $next_business_day = null, $message_reference = null, $message_reference_date = null, $plugin_name = null, $plugin_version = null, $shipping_system_platform_name = null, $shipping_system_platform_version = null, $webstore_platform_name = null, $webstore_platform_version = null, $strict_validation = false, $get_all_value_added_services = false, $request_estimated_delivery_date = true, $estimated_delivery_date_type = 'QDDF', string $contentType = self::contentTypes['expApiProducts'][0])
    {
        return $this->expApiProductsAsyncWithHttpInfo($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code, $destination_postal_code, $next_business_day, $message_reference, $message_reference_date, $plugin_name, $plugin_version, $shipping_system_platform_name, $shipping_system_platform_version, $webstore_platform_name, $webstore_platform_version, $strict_validation, $get_all_value_added_services, $request_estimated_delivery_date, $estimated_delivery_date_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation expApiProductsAsyncWithHttpInfo
     *
     * Retrieve available DHL Express products for a one piece Shipment
     *
     * @param  string $account_number DHL Express customer account number (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function expApiProductsAsyncWithHttpInfo($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code = null, $destination_postal_code = null, $next_business_day = null, $message_reference = null, $message_reference_date = null, $plugin_name = null, $plugin_version = null, $shipping_system_platform_name = null, $shipping_system_platform_version = null, $webstore_platform_name = null, $webstore_platform_version = null, $strict_validation = false, $get_all_value_added_services = false, $request_estimated_delivery_date = true, $estimated_delivery_date_type = 'QDDF', string $contentType = self::contentTypes['expApiProducts'][0])
    {
        $returnType = '\MyDHL\Client\Model\SupermodelIoLogisticsExpressProducts';
        $request = $this->expApiProductsRequest($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code, $destination_postal_code, $next_business_day, $message_reference, $message_reference_date, $plugin_name, $plugin_version, $shipping_system_platform_name, $shipping_system_platform_version, $webstore_platform_name, $webstore_platform_version, $strict_validation, $get_all_value_added_services, $request_estimated_delivery_date, $estimated_delivery_date_type, $contentType);
    ...
    /**
     * Create request for operation 'expApiProducts'
     *
     * @param  string $account_number DHL Express customer account number (required)
     * @param  string $origin_country_code A short text string code (see values defined in ISO 3166) specifying the shipment origin country. https://gs1.org/voc/Country, Alpha-2 Code (required)
     * @param  string $origin_city_name Text specifying the city name (required)
     ...
     */
    public function expApiProductsRequest($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code = null, $destination_postal_code = null, $next_business_day = null, $message_reference = null, $message_reference_date = null, $plugin_name = null, $plugin_version = null, $shipping_system_platform_name = null, $shipping_system_platform_version = null, $webstore_platform_name = null, $webstore_platform_version = null, $strict_validation = false, $get_all_value_added_services = false, $request_estimated_delivery_date = true, $estimated_delivery_date_type = 'QDDF', string $contentType = self::contentTypes['expApiProducts'][0])
    {
        ...
        if ($account_number === null || (is_array($account_number) && count($account_number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_number when calling expApiProducts'
            );
        }
        ...
        if ($origin_country_code === null || (is_array($origin_country_code) && count($origin_country_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $origin_country_code when calling expApiProducts'
            );
        }
        ...
        if ($origin_city_name === null || (is_array($origin_city_name) && count($origin_city_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $origin_city_name when calling expApiProducts'
            );
        }
        ...
        if ($destination_country_code === null || (is_array($destination_country_code) && count($destination_country_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $destination_country_code when calling expApiProducts'
            );
        }
        ...
        if ($destination_city_name === null || (is_array($destination_city_name) && count($destination_city_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $destination_city_name when calling expApiProducts'
            );
        }
        ...
        if ($weight === null || (is_array($weight) && count($weight) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $weight when calling expApiProducts'
            );
        }
        if ($weight > 999999999999) {
            throw new \InvalidArgumentException('invalid value for "$weight" when calling ProductApi.expApiProducts, must be smaller than or equal to 999999999999.');
        }
        if ($weight < 0) {
            throw new \InvalidArgumentException('invalid value for "$weight" when calling ProductApi.expApiProducts, must be bigger than or equal to 0.');
        }
        
        // verify the required parameter 'length' is set
        if ($length === null || (is_array($length) && count($length) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $length when calling expApiProducts'
            );
        }
        if ($length > 9999999999) {
            throw new \InvalidArgumentException('invalid value for "$length" when calling ProductApi.expApiProducts, must be smaller than or equal to 9999999999.');
        }
        if ($length < 1) {
            throw new \InvalidArgumentException('invalid value for "$length" when calling ProductApi.expApiProducts, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'width' is set
        if ($width === null || (is_array($width) && count($width) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $width when calling expApiProducts'
            );
        }
        if ($width > 9999999999) {
            throw new \InvalidArgumentException('invalid value for "$width" when calling ProductApi.expApiProducts, must be smaller than or equal to 9999999999.');
        }
        if ($width < 1) {
            throw new \InvalidArgumentException('invalid value for "$width" when calling ProductApi.expApiProducts, must be bigger than or equal to 1.');
        }
        
        // verify the required parameter 'height' is set
        if ($height === null || (is_array($height) && count($height) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $height when calling expApiProducts'
            );
        }
        if ($height > 9999999999) {
            throw new \InvalidArgumentException('invalid value for "$height" when calling ProductApi.expApiProducts, must be smaller than or equal to 9999999999.');
        }
        if ($height < 1) {
            throw new \InvalidArgumentException('invalid value for "$height" when calling ProductApi.expApiProducts, must be bigger than or equal to 1.');
        }
        ...
        if ($planned_shipping_date === null || (is_array($planned_shipping_date) && count($planned_shipping_date) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $planned_shipping_date when calling expApiProducts'
            );
        }
        ...
        if ($is_customs_declarable === null || (is_array($is_customs_declarable) && count($is_customs_declarable) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $is_customs_declarable when calling expApiProducts'
            );
        }
        ...
        if ($unit_of_measurement === null || (is_array($unit_of_measurement) && count($unit_of_measurement) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unit_of_measurement when calling expApiProducts'
            );
        }
        ...
        if ($message_reference !== null && strlen($message_reference) > 36) {
            throw new \InvalidArgumentException('invalid length for "$message_reference" when calling ProductApi.expApiProducts, must be smaller than or equal to 36.');
        }
        if ($message_reference !== null && strlen($message_reference) < 28) {
            throw new \InvalidArgumentException('invalid length for "$message_reference" when calling ProductApi.expApiProducts, must be bigger than or equal to 28.');
        }
        

        if ($plugin_name !== null && strlen($plugin_name) > 20) {
            throw new \InvalidArgumentException('invalid length for "$plugin_name" when calling ProductApi.expApiProducts, must be smaller than or equal to 20.');
        }
        
        if ($plugin_version !== null && strlen($plugin_version) > 15) {
            throw new \InvalidArgumentException('invalid length for "$plugin_version" when calling ProductApi.expApiProducts, must be smaller than or equal to 15.');
        }
        
        if ($shipping_system_platform_name !== null && strlen($shipping_system_platform_name) > 20) {
            throw new \InvalidArgumentException('invalid length for "$shipping_system_platform_name" when calling ProductApi.expApiProducts, must be smaller than or equal to 20.');
        }
        
        if ($shipping_system_platform_version !== null && strlen($shipping_system_platform_version) > 15) {
            throw new \InvalidArgumentException('invalid length for "$shipping_system_platform_version" when calling ProductApi.expApiProducts, must be smaller than or equal to 15.');
        }
        
        if ($webstore_platform_name !== null && strlen($webstore_platform_name) > 20) {
            throw new \InvalidArgumentException('invalid length for "$webstore_platform_name" when calling ProductApi.expApiProducts, must be smaller than or equal to 20.');
        }
        
        if ($webstore_platform_version !== null && strlen($webstore_platform_version) > 15) {
            throw new \InvalidArgumentException('invalid length for "$webstore_platform_version" when calling ProductApi.expApiProducts, must be smaller than or equal to 15.');
        }
